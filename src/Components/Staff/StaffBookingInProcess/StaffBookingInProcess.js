  ...
  return (
    <>
            ...
            <table className="staff-booking-in-process__table">
              ...
              {bookingLoading
                  ...
                  :bookings.length === 0 ? (
                    <tr>
                      <td colSpan={7}>
                        <div className="staff-booking-in-process__notValid">
                ...
                (bookings &&
                  bookings.map((booking) => (
                    <tr key={booking.id}>
                      <td className="staff-booking-in-process__id">
                        {booking.id}
                      </td>
                      <td>
      ...
      {isModalOpen && (
        <>
          <div
            className="staff-booking-in-process-backdrop"
            onClick={toggleModal}
          >
            <div
            ...
            >
              <form onSubmit={handleSubmit}>
                <h2 className="staff-booking-in-process-modal__header">
                  Update Booking
                </h2>
