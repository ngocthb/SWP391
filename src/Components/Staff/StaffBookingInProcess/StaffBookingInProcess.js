...
import "./StaffBookingInProcess.scss";
...
const StaffBookingInProcess = ({ buttonLabel }) => {
  ...
  const fetchBookings = async (page) => {
    ...
    try {
      const response = await api.get(
        `manager/stylists/booking/inprocess/${page}/6/${staff.salonId}/${formatDateForInput(selectedDate)}`
      );
  ...
  }, [isUpdate, staff, isStaffLoaded, selectedDate, currentPage]);
  ...
  return (
    <>
      <div className="staff-booking-in-process">
        <div className="staff-booking-in-process__header">
          <div className="staff-booking-in-process__header-searchBar">
          ...
          <div className="staff-booking-in-process__header-filter">
            <select
              value={
        ...
        <div className="staff-booking-in-process__container">
          <div className="staff-booking-in-process__content">
            <table className="staff-booking-in-process__table">
              <thead>
                <tr>
              ...
              <tbody>
                {bookings &&
                  bookings.map((booking) => (
                    <tr key={booking.id}>
                      <td className="staff-booking-in-process__id">{booking.id}</td>
                      <td>
                        <div className="staff-booking-in-process__customer">
                          <span className="staff-booking-in-process__customer-name">
                            {booking.customerName}
                          </span>
                        </div>
                      </td>
                      <td className="staff-booking-in-process__status">
                        {booking.customerPhone}
                      </td>
                      <td className="staff-booking-in-process__discountAmount">
                        {booking.stylistName}
                      </td>
                      <td>
                        <span className={`staff-booking-in-process__quantity`}>
                      ...
                      <td className="staff-booking-in-process__actions">
                      <button
                        className="staff-booking-in-process__action-button"
                      ...
                      >
                        ...
                        <button className="staff-booking-in-process__action-button">
                          🗑
                        </button>
                      </td>
                    </tr>
      ...
      {isModalOpen && (
        <>
          <div className="staff-booking-in-process-backdrop" onClick={toggleModal}>
            <div
              className="staff-booking-in-process-modal"
              onClick={(e) => e.stopPropagation()}
            >
              <form onSubmit={handleSubmit}>
                <h2 className="staff-booking-in-process-modal__header">Update Booking</h2>
                <div className="staff-booking-in-process-modal__form-section">
                  <div className="staff-booking-in-process-modal__form-grid">
                    <div className="staff-booking-in-process-modal__form-grid staff-booking-in-process-modal__form-grid--half-width">
                      <div className="staff-booking-in-process-modal__form-group">
                        <label
                        ...
                        <input
                          type="text"
                          id="customerName"
                          className="staff-booking-in-process-modal__input"
                    ...
                    <div
                      className="staff-booking-in-process-modal__form-grid
              staff-booking-in-process-modal__form-grid--half-width"
                    >
                      <div className="staff-booking-in-process-modal__form-group">
                        <label
                          htmlFor="stylistName"
                    ...
                    <div className="staff-booking-in-process-modal__form-grid staff-booking-in-process-modal__form-grid--full-width">
                      <div className="staff-booking-in-process-modal__form-group">
                        <label
                          htmlFor="time"
                          className="staff-booking-in-process-modal__label"
                        ...
                        <div className="staff-booking-in-process-modal__slots-list">
                          {(slots || []).map((time) => (
                            <label
                              key={time.slotid}
                              className={`staff-booking-in-process-modal__slots-option disabled`}
                            >
                              <input
                                type="radio"
                                name="time"
                                ...
                                disabled
                                className={`staff-booking-in-process-modal__radio disabled`}
                              />
                    ...
                    <div
                      className="staff-booking-in-process-modal__form-grid
                staff-booking-in-process-modal__form-grid--full-width"
                    >
                      <div className="staff-booking-in-process-modal__form-group">
                        <label
                          htmlFor="serviceName"
                        ...
                        <div className="staff-booking-in-process-modal__services-list">
                          {(services || []).map((service) => (
                            <label
                              key={service.serviceId}
                              className="staff-booking-in-process-modal__option"
                            >
                              <input
                                type="checkbox"
                ...
                staff-booking-in-process-modal__form-grid--full-width"
                    >
                      <div className="staff-booking-in-process-modal__form-group staff-booking-in-process-modal__form-group--full-width">
                        <label
                          htmlFor="salon"
                          className="staff-booking-in-process-modal__label"
                        >
                ...
                <div className="staff-booking-in-process-modal__button-container">
                  <button
                    type="submit"
                    className="staff-booking-in-process-modal__button"
                    disabled={loading}
                  >
...
export default StaffBookingInProcess;
