  ...
  useEffect(() => {
    ...
    return (
              ...
              <table className="manager-booking-complete__table">
                ...
                {bookingLoading
                  ...
                  : bookings.length === 0 ? (
                    ...
                    <td className="manager-booking-complete__actions">
                      <button
                        className="manager-booking-complete__action-button"
      ...
      {isModalOpen && (
        <>
          <div
            className="manager-booking-complete-backdrop"
            onClick={toggleModal}
          >
            <div
              className="manager-booking-complete-modal"
              onClick={(e) => e.stopPropagation()}
            >
              <form>
                <h2 className="manager-booking-complete-modal__header">
                  Booking Detail
                </h2>
                <div className="manager-booking-complete-modal__form-section">
                  <div className="manager-booking-complete-modal__form-grid">
                    <div className="manager-booking-complete-modal__form-grid manager-booking-complete-modal__form-grid--half-width">
                      <div className="manager-booking-complete-modal__form-group">
                        <label
                          htmlFor="customerName"
                          className="manager-booking-complete-modal__label"
                        >
                          Customer Name:
                        </label>
                        <input
                          type="text"
                          id="customerName"
                          className="manager-booking-complete-modal__input"
                    ...
                    <div className="manager-booking-complete-modal__form-grid manager-booking-complete-modal__form-grid--full-width">
                      <div className="manager-booking-complete-modal__form-group">
                        <label
                          htmlFor="time"
                          className="manager-booking-complete-modal__label"
                        ...
                        <div className="manager-booking-complete-modal__slots-list">
                          {(slots || []).map((time) => (
                            <label
                              key={time.slotid}
                              className={`manager-booking-complete-modal__slots-option disabled`}
                            >
                              <input
                                type="radio"
                                name="time"
                                ...
                                disabled
                                className={`manager-booking-complete-modal__radio disable`}
                              />
                    ...
                    <div
                      className="manager-booking-complete-modal__form-grid
              manager-booking-complete-modal__form-grid--half-width"
                    >
                      <div className="manager-booking-complete-modal__form-group">
                        <label
                          htmlFor="date"
                    ...
                    <div
                      className="manager-booking-complete-modal__form-grid
                manager-booking-complete-modal__form-grid--full-width"
                    >
                      <div className="manager-booking-complete-modal__form-group">
                        <label
                          htmlFor="serviceName"
                        ...
                        <div className="manager-booking-complete-modal__services-list">
                          {(services || []).map((service) => (
                            <label
                              key={service.id}
                              className="manager-booking-complete-modal__option disabled"
                            >
                              <input
                                type="checkbox"
                                checked={selectedServices.includes(service.id)}
                                disabled
                                className="manager-booking-complete-modal__checkbox disable"
                              />
                               <span>
                                {service.serviceName} -{" "}
