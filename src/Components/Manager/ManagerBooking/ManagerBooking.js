        ...
        <div className="manager-booking__content">
          <table className="manager-booking__table">
            ...
            <tbody>
              {orders.map((order) => (
                <tr key={order.id}>
                  <td className="manager-booking__id">{order.id}</td>
                  <td>
                    <div className="manager-booking__customer">
                      <img src={order.img} alt={order.customer} className="manager-booking__customer-image" />
                      <span className="manager-booking__customer-name">{order.customer}</span>
                    </div>
                  </td>
                  <td className="manager-booking__date">{order.date}</td>
                  <td className="manager-booking__amount">{order.amount}</td>
                  <td>
                    <span className={`manager-booking__status manager-booking__status--${order.status}`}>
